...
#define FFMPEG_CONFIGURATION "--prefix=/usr/local/ffmpeg --enable-shared --enable-yasm --enable-libx264 --enable-libopenh264 --enable-gpl --enable-pthreads --extra-cflags=-I/usr/local/x264/include --extra-ldflags=-L/usr/local/x264/lib --extra-cflags=-I/usr/local/include --extra-ldflags=-L/usr/local/lib --extra-ldflags=-L/opt/intel/mediasdk/lib/lin_x64 --enable-nonfree --enable-encoder=h264_qsv --enable-decoder=h264_qsv --enable-encoder=h265_qsv --enable-decoder=h265_qsv --enable-libmp3lame --enable-libfdk-aac --enable-nonfree --enable-libopus --enable-nonfree --enable-muxer=opus"
...
#define CONFIG_CUVID 1  // modify by mobinsheng 修改为0,有需要可以修改为1
